...
import (
	...
	"github.com/995933447/idgen/idgenserver/boot"
	"github.com/995933447/idgen/idgenserver/config"
	"github.com/995933447/idgen/idgenserver/event"
...
func main() {
	if err := boot.InitNode("idgen"); err != nil {
	...
	config.SafeReadServerConfig(func(c *config.ServerConfig) {
		...
		if err := idgen.PrepareGRPC(context.TODO(), discoveryName); err != nil {
			log.Fatal(runtimeutil.NewStackErr(err))
		}
	})
